...
<div class="row">
    <div class="col-lg-4 information">
        <div class="prod_image"><img src="<?php echo $product->image ?>"></div>
    ...
    <div class="col-lg-8 description">
        ...
        <form method="post" action="" class="jcart">
                ...
                <button type="submit" name="my-add-button" class="btn btn-success btn-lg add-to-cart"><span class="glyphicon glyphicon-shopping-cart
